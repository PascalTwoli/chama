  ...
  const handleSaveAccountChanges = () => {
	...
	const renderRoleProfile = (role: Role) => (
		<div className="leadership-roles flex flex-col items-center gap-2 text-center text-gray-300 p-2">
			<h4 className="text-md w-full border pb-2 mb-2 mt-2 font-bold">
				{role}
			</h4>
			<label htmlFor={`${role}-upload`} >
				<div  className={`w-36 h-36 bg-gray-800 border-2 border-gray-600 hover:border-blue-400 transition-all duration-200 rounded-full flex items-center justify-center overflow-hidden ${isEditing? "cursor-pointer profileEditing" : "cursor-not-allowed opacity-90"}`}>
					{roleProfile[role] ? (
						<img
					...
					{activeTab === "Account" && (
                        ...
                        disabled={!isEditing}
									...
									<div className={`flex flex-2 flex-col items-center justify-center text-center text-gray-400`}>
										<label
											...
											<div className={`w-40 h-40  transition-all duration-200 rounded-full flex items-center justify-center overflow-hidden bg-gray-800 ${isEditing? "profileEditing" : ""}`}>
												{selectedImage ? (
													<img
														src={selectedImage}
														alt="Uploaded"
                      ...
                      disabled={!isEditing}
										...
										<span className="mt-2 text-sm">
											Profile of the Chama
										</span>
									</div>
								</div>

								{isEditing && <div className="flex gap-6 justify-end items-center mt-6">
                  <Button label="Cancel" onClick={() => setIsEditing(false)} severity="secondary" className=" h-10"/>
									<Button
										type="button"
										label="Update Chama"
										icon="pi pi-check"
						...
						<div className="rounded ">
							<div className="text-center font-bold bg-[#242E3B] rounded-lg shadow-lg px-5 py-3">
								...
								<div className="text-left text-gray-400">
									<p>
										{" "}
										Initiate a fresh start with the removal of all the
										existing. Please be aware that the following data
									...
									<ul className="ml-10 m-3 list-disc">
										...
										<li>
											All meetings held, minutes and attendance
											records
										</li>
							...
							<div className="font-bold bg-[#242E3B] rounded-lg shadow-lg mt-6 px-5 py-3">
								...
								<div className="text-gray-400">
									<p>
										Note: All members will receive notice if this
										group is deleted. Kindly take note of the
										following information:
									</p>
									<ul className="ml-10 mt-3 list-decimal">
										<li>
											Retention perion: You will have six months,
											until 19 september 2025, to access any group
											data that is necessary
										</li>
										<li className="">
											Information to be Removed Following Retention
											Term
											<ul className="ml-10 m-3 list-disc">
												<li>All Active or Historical Soft loans</li>
												<li>
													All accounts, transactions and balances
												</li>
												<li>
													All meetings held, minutes and attendance
													records
												...
												<li>
													All balances, accounts, and transactions
													related to them
												</li>
											</ul>
										</li>
										<li>
											Erreversible action: This data will not be
											retrieved after the retention term
										</li>
									</ul>
								</div>
								<div className="text-right">
