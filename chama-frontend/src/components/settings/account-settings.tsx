    ...
    <div className="px-6 text-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#242E3B] rounded-xl p-6">
          <h3 className="text-lg  text-gray-300 font-bold mt-0 mb-4">Profile Details</h3>
          <div className="flex flex-col gap-8 items-center">
            <div className="w-full flex justify-end items-center">
              <Button onClick={() => setIsEditing(true)} className=" profile-edit-btn w-14 mt-0 justify-center text-gray-400 hover:border hover:border-gray-400 p-2 rounded-x-lg hover:bg-gray-700 transition-all p-button-info p-button-outlined">
          ...
          <div className="mt-6 flex justify-end">
            {isEditing && (
              <div className="flex gap-2 mt-4">
                <Button label="Cancel" onClick={() => setIsEditing(false)} severity="secondary" />
                <Button onClick={ handleSaveProfileChanges} label="Save changes" className="bg-[#4084B9] border-[#4084B9] px-6 py-2 font-normal" />
              </div>
            )}
          </div>
