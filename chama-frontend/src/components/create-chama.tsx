          ...
          <div className="flex flex-col gap-6">
              <div className="">
                <div className='basic-info-cont  mb-4'>
                  ...
                  <p className='m-0 mb-2 text-sm'>Set up the fundamental details of your chama</p>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  ...
                  <div>
                    <label htmlFor="organizationRole" className="font-bold">
                      Your organisation role <span className="text-red-500">*</span>
                      <select
      ...
      <div className="w-full max-h-full  p-8 pt-0 text-white px-40">
        <div className='flex justify-between items-center mb-8'>
          <div>
            ...
            <p className="font-[200] m-0 text-sm">Start your savings journey with a new chama group</p>
          </div>
          <button className='flex items-center gap-2 text-gray-400 hover:text-white transition-colors h-[35px] rounded border-none' onClick={() => navigate('/chamas')}>
