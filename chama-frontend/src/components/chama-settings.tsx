...
//                         className='w-full p-inputtext-sm bg-gray-800 border border-gray-600 rounded-md transition-all duration-200 hover:border-blue-400 focus:border-blue-500'
//                       />
//                     </div>
//                     <div>
...
//                     label='Update Chama'
//                     icon='pi pi-check'
//                     className='mt-6 p-button p-button-outlined p-button-info'
...
//                 <h3 className='font-bold text-xl mb-4 pb-2 border-b border-gray-600'>
...
//                 </div>
//               </div>
//               <div className='h-3 bg-gray-800 mt-6 mb-8'></div>
...
//                     label={`Delete ${chamaName}'s account`}
//                     style={{ height: '2.5rem' }}
//                   />
//                 </div>
//               </div>
