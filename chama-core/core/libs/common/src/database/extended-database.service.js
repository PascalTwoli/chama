 ...
 */
let ExtendedDatabaseService = class ExtendedDatabaseService
  extends database_service_1.DatabaseService
{
  constructor() {
    super(...arguments);
  ...
  paginateWithRelations(modelName, args) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        this.validatePaginationArgs(args);
        const { include } = args,
          paginationArgs = __rest(args, ['include']);
  ...
  searchAndPaginate(modelName, searchTerm, searchFields, args) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const paginationArgs = Object.assign(Object.assign({}, args), {
  ...
  getPaginationMeta(modelName_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function* (modelName, filters = {}, perPage = 10) {
        try {
          const model = this.extendedClient[modelName];
          if (!model) {
            throw new Error(`Model '${modelName}' not found`);
