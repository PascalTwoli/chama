...
export interface CrudOperations<T, CreateInput, UpdateInput, WhereInput, WhereUniqueInput> {
  findMany(args?: { where?: WhereInput; orderBy?: any; skip?: number; take?: number; include?: any }): Promise<T[]>;
  findUnique(args: { where: WhereUniqueInput; include?: any }): Promise<T | null>;
  create(args: { data: CreateInput; include?: any }): Promise<T>;
  update(args: { where: WhereUniqueInput; data: UpdateInput; include?: any }): Promise<T>;
...
export class DatabaseService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
   ...
   */
  async executeTransaction<T>(operations: Prisma.PrismaPromise<any>[]): Promise<T[]> {
    try {
