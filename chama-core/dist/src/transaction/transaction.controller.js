...
let TransactionController = class TransactionController {
    ...
    createTransaction(createTransactionDto, currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.transactionService.createTransaction(createTransactionDto, currentUser.id);
            }
            catch (error) {
                ...
                throw new common_1.InternalServerErrorException(`Failed to create transaction: ${error instanceof Error ? error.message : 'Unknown error'}`);
            }
        });
    }
    /**
    ...
    getTransactionsByChama(chamaId, type, startDate, endDate, currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield this.transactionService.getTransactionsByChama(chamaId, currentUser.id, type, startDate, endDate);
            }
            catch (error) {
                if (error instanceof common_1.NotFoundException) {
                    throw error;
                ...
                throw new common_1.InternalServerErrorException(`Failed to fetch transactions: ${error instanceof Error ? error.message : 'Unknown error'}`);
            }
        });
    }
    /**
    ...
    getTransactionById(id, currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const transaction = yield this.transactionService.getTransactionById(id, currentUser.id);
                ...
                throw new common_1.InternalServerErrorException(`Failed to fetch transaction: ${error instanceof Error ? error.message : 'Unknown error'}`);
            }
        });
    }
    /**
    ...
    getUserTransactionSummary(currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.transactionService.getUserTransactionSummary(currentUser.id);
            }
            catch (error) {
                throw new common_1.InternalServerErrorException(`Failed to fetch transaction summary: ${error instanceof Error ? error.message : 'Unknown error'}`);
            }
        });
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'chamaId', description: 'ID of the chama', type: 'string' }),
    ...
    __metadata("design:returntype", Promise)
], TransactionController.prototype, "getTransactionsByChama", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TransactionController.prototype, "getUserTransactionSummary", null);
