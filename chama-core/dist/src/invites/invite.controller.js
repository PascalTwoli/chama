...
let InviteController = class InviteController {
    ...
    async createInvite(createInviteDto, currentUser) {
        try {
    ...
    async listPendingInvites(chamaId, currentUser) {
        try {
    ...
    async acceptInvite(acceptInviteDto, currentUser) {
        try {
            const membership = await this.inviteService.validateAndAcceptInvite(acceptInviteDto.token, currentUser.id);
    ...
    async getPendingInvitesForUser(currentUser) {
