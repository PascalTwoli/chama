...
let InviteController = class InviteController {
  ...
  createInvite(createInviteDto, currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const invite = yield this.inviteService.createInvite(
          createInviteDto,
          currentUser.id,
        );
  ...
  listPendingInvites(chamaId, currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const invites = yield this.inviteService.listPendingInvites(
          chamaId,
          currentUser.id,
        );
  ...
  acceptInvite(acceptInviteDto, currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const membership = yield this.inviteService.validateAndAcceptInvite(
  ...
  getPendingInvitesForUser(currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const invites = yield this.inviteService.getPendingInvitesForUser(
          currentUser.email,
        );
        return invites.map(invite => new invite_entity_1.InviteEntity(invite));
      } catch (error) {
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'Create a new invite to join a chama',
    }),
    ...
    __metadata('design:paramtypes', [
      create_invite_dto_1.CreateInviteDto,
      Object,
    ]),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({
      summary: 'List all pending invites for a chama',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
...
__decorate(
  [
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({
      summary: 'Accept an invite to join a chama',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
    ...
    (0, swagger_1.ApiResponse)({
      status: 409,
      description: 'Already a member of this chama',
    }),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ transform: true })),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [
      create_invite_dto_1.AcceptInviteDto,
      Object,
    ]),
    __metadata('design:returntype', Promise),
  ],
