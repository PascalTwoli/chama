    ...
    canActivate(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!token && request.cookies) {
                ...
                if (!token && ((_a = request.url) === null || _a === void 0 ? void 0 : _a.includes('/admin'))) {
            ...
            const modifiedRequest = Object.assign(Object.assign({}, request), { headers: Object.assign(Object.assign({}, request.headers), { authorization: `Bearer ${token}` }) });
            // Validate token using UserService
            const decodedToken = yield this.userService.validateRequestAndGetToken(modifiedRequest);
            if (!decodedToken) {
...
exports.AuthGuard = AuthGuard = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof user_service_1.UserService !== "undefined" && user_service_1.UserService) === "function" ? _a : Object, typeof (_b = typeof prisma_service_1.PrismaService !== "undefined" && prisma_service_1.PrismaService) === "function" ? _b : Object])
], AuthGuard);
