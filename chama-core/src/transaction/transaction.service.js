...
let TransactionService = class TransactionService {
  ...
  createTransaction(createTransactionDto, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const transaction = yield this.prisma.$transaction(prisma =>
  ...
  getTransactionsByChama(chamaId, userId, type, startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!chama) {
        throw new common_1.NotFoundException(
          `Chama with ID ${chamaId} not found`,
        );
      }
      ...
      // Get transactions
      const transactions = yield this.prisma.$transaction(prisma =>
        __awaiter(this, void 0, void 0, function* () {
      ...
      return transactions.map(transaction =>
        Object.assign(Object.assign({}, transaction), {
          amount: Number(transaction.amount),
          description: transaction.description || undefined,
          reference: transaction.reference || undefined,
        }),
  ...
  getTransactionById(id, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { chama } = transaction,
        transactionData = __rest(transaction, ['chama']);
      return Object.assign(Object.assign({}, transactionData), {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      transactions.forEach(transaction => {
        ...
        if (transaction.type === client_1.TransactionType.CONTRIBUTION) {
          ...
          transaction.type === client_1.TransactionType.LOAN_REPAYMENT
        ) {
        ...
        if (!chamaStatMap.has(transaction.chamaId)) {
          const chama =
            (_a = memberships.find(m => m.chamaId === transaction.chamaId)) ===
              null || _a === void 0
              ? void 0
              : _a.chama;
          chamaStatMap.set(transaction.chamaId, {
            ...
            chamaName:
              (chama === null || chama === void 0 ? void 0 : chama.name) ||
              'Unknown Chama',
            contributions: 0,
            withdrawals: 0,
            loans: 0,
