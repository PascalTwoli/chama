    ...
    createTransaction(createTransactionDto, currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new common_1.InternalServerErrorException(`Failed to create transaction: ${error.message || 'Unknown error'}`);
            }
        });
    }
    /**
    ...
    getUserTransactionSummary(currentUser) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new common_1.InternalServerErrorException(`Failed to fetch transaction summary: ${error.message || 'Unknown error'}`);
            }
        });
    }
};
