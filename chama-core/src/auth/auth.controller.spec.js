...
describe('AuthController', () => {
    ...
    describe('getCurrentUser', () => {
        it('should return current user information', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect((_a = result.firebaseUser) === null || _a === void 0 ? void 0 : _a.uid).toBe('firebase123');
            expect(result.localUser.id).toBe('user123');
        }));
        it('should throw BadRequestException when user service fails', () => __awaiter(void 0, void 0, void 0, function* () {
            const mockCurrentUser = {
                id: 'user123',
                firebaseUid: 'firebase123',
                email: 'test@example.com',
            ...
            yield expect(controller.getCurrentUser(mockCurrentUser)).rejects.toThrow(common_1.BadRequestException);
            yield expect(controller.getCurrentUser(mockCurrentUser)).rejects.toThrow('Failed to fetch current user: User not found');
        }));
        it('should handle user response without Firebase user', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            const mockCurrentUser = {
                id: 'user123',
                firebaseUid: 'firebase123',
            ...
            expect(result.localUser).toBeDefined();
            expect((_a = result.localUser) === null || _a === void 0 ? void 0 : _a.id).toBe('user123');
        }));
    });
});
