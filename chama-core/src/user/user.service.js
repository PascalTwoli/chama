  ...
  registerUser(registerUser) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const localUser = yield this.databaseService.$transaction(prisma =>
        ...
        if (errorWithCode.code === 'auth/email-already-exists') {
          ...
          (_a = errorWithCode.code) === null || _a === void 0
            ? void 0
            : _a.includes('prisma')
        ) {
          const message =
  ...
  refreshAuthToken(refreshToken) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        } = yield this.sendRefreshAuthTokenRequest(refreshToken);
        return {
          idToken,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const listUsersResult = yield firebaseAdmin
          ...
          .listUsers(
            maxResults,
            params === null || params === void 0 ? void 0 : params.pageToken,
          );
        return {
      ...
      try {
        ...
        if (errorWithCode.code === 'auth/user-not-found') {
          ...
          if (localUser) {
            ...
            console.warn(
              `Local user ${uid} exists but Firebase user is missing`,
            );
            return {
              localUser: localUser,
            };
  ...
  updateLocalUser(uid, updateData) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const updatedUser = yield this.databaseService.$transaction(prisma =>
          __awaiter(this, void 0, void 0, function* () {
  ...
  remove(uid) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield this.databaseService.$transaction(prisma =>
          __awaiter(this, void 0, void 0, function* () {
