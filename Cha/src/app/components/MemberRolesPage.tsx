...
export default function MemberRolesPage({
  ...
  const handleSaveRole = () => {
    if (selectedMember) {
      toast.success(
        `Updated ${selectedMember.name}'s role to ${roleInfo[newRole].name}`
      );
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage member access and responsibilities
            </p>
          </div>
        </div>
      </div>
                ...
                {filteredMembers.map(member => (
                  <tr key={member.id} className="border-b hover:bg-muted/50">
                    ...
                    <td className="py-3 px-4">
                      <Badge
                        variant="outline"
                        className={roleInfo[member.role].color}
                      >
                    ...
                    <div className="flex items-start gap-3">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor:
                            newRole === role ? '#2F7CF7' : 'transparent',
                        }}
                      >
                        {newRole === role && (
