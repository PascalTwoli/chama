          ...
          <CardContent className="pt-6">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-bold">
                KSh {financialSummary.totalCollected.toLocaleString()}
              </p>
              <div className="flex items-center gap-1 text-sm">
                <ArrowDownRight className="w-4 h-4 text-destructive" />
                <span className="text-destructive">
                  {Math.abs(financialSummary.monthlyGrowth)}% vs last month
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-bold">
                KSh {financialSummary.averageContribution.toLocaleString()}
              </p>
              <p className="text-sm text-muted-foreground">
                ...
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={monthlyContributions}>
                      ...
                      />
                      <YAxis tick={{ fontSize: 12 }} stroke="rgba(0,0,0,0.5)" />
        ...
        <TabsContent value="members" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Individual member performance overview
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            KSh {member.paid.toLocaleString()} / KSh{' '}
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-secondary/10 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      94.5% collection rate maintained
                    </p>
                  </div>
                </div>
                ...
                {upcomingObligations.map((obligation, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Due:{' '}
                        {new Date(obligation.date).toLocaleDateString('en-KE')}
                      </p>
                    </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between pb-3 border-b">
                  ...
                  <span className="font-bold">
                    KSh {financialSummary.totalExpected.toLocaleString()}
                  </span>
                </div>
                <div className="flex items-center justify-between pb-3 border-b">
                ...
                <div className="flex items-center justify-between pb-3 border-b">
                  ...
                  <span className="font-bold text-destructive">
                    KSh{' '}
                    {(
                      financialSummary.totalExpected -
