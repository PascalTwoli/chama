...
export default function App() {
  ...
  if (activeView === 'dashboard') {
    return (
      <ThemeProvider>
        <Dashboard role={userRole} onLogout={() => setActiveView('landing')} contributionModel={contributionModel} />
      </ThemeProvider>
    );
  }
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between max-w-6xl">
          <div className="flex items-center gap-2">
            <img src={logoImage} alt="ChamaPlus Logo" className="h-10 w-auto" />
          </div>
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <img src={logoImage} alt="ChamaPlus Logo" className="h-12 w-auto" />
          </div>
