...
export default function GenerateReport({ onBack }: GenerateReportProps) {
  ...
  const generatePDF = () => {
    ...
    for(let i = 1; i <= pageCount; i++) {
      ...
      doc.text('ChamaPlus - Tumaini Chama', 14, doc.internal.pageSize.getHeight() - 10);
    }
    
    // Save the PDF
    doc.save(`ChamaPlus-Report-${reportType}-${new Date().toISOString().split('T')[0]}.pdf`);
            ...
            <CardContent>
              <form onSubmit={handleGenerate} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <Button type="button" variant="outline" disabled={!reportType} onClick={generatePDF}>
