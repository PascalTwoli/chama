              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg border border-border">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Welcome to {chamaName}! We're excited to have you join our
                      savings group. Our goal is to support each other
                      financially and grow together. Contributions are{' '}
                      {contributionModel === 'fixed'
                        ? `KSh ${fixedAmount} ${contributionFrequency}`
                        : 'flexible - contribute what you can, when you can'}
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg border border-border">
                    ...
                    <div className="text-xs text-muted-foreground space-y-1">
                      <p>
                        ...
                        {contributionModel === 'fixed'
                          ? `KSh ${fixedAmount} every ${contributionFrequency}`
                          : 'flexibly based on ability'}
                      </p>
                      {contributionModel === 'fixed' && (
                        <>
                          <p>
                            2. Contributions due on day {contributionDay} of
                            each{' '}
                            {contributionFrequency === 'monthly'
                              ? 'month'
                          ...
                          <p>
                            3. Grace period: {latePaymentGraceDays} days, Late
                            fee: KSh {lateFee}
                          </p>
                        </>
                      )}
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          toast.success(
                            'Contribution guidelines copied to clipboard!'
                          );
                        }}
                      >
                        <Copy className="w-4 h-4" />
                    ...
                    <div className="text-xs text-muted-foreground space-y-1">
                      ...
                      {contributionModel === 'fixed' ? (
                        ...
                        <>
                          ...
                          {minimumContribution && (
                            <p>• Minimum: KSh {minimumContribution}</p>
                          )}
                        </>
                      )}
